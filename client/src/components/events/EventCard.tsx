...
export const EventCard = ({ event }: EventCardProps) => {
  ...
  return (
    <article className="group flex flex-col sm:flex-row border border-stone-200 bg-white rounded-lg overflow-hidden hover:border-stone-300 hover:shadow-md transition-all duration-200">
      {/* Date column */}
      <div className="flex sm:flex-col items-center sm:items-center justify-start sm:justify-start gap-4 sm:gap-0 px-5 py-4 sm:py-5 sm:px-5 sm:min-w-20 bg-stone-50 border-b sm:border-b-0 sm:border-r border-stone-200">
        <div className="text-center">
          ...
          <p className="text-xs font-medium text-stone-500 mt-0.5">{d.month}</p>
